...
"builtin.module"() ({
  ...
  ^bb0(%arg0: tensor<23x12xf16>, %arg1: tensor<?x?x12xi16>, %arg2: vector<23x21x23xi1>):
    ...
    %12 = "affine.apply"(%11, %9, %7, %10) <{map = #map}> : (index, index, index, index) -> index
    ...
    %18 = "vector.broadcast"(%0) : (f32) -> vector<21x12x12xf32>
    %19 = "vector.broadcast"(%0) : (f32) -> vector<21x12x12xf32>
    %20 = "vector.broadcast"(%0) : (f32) -> vector<21x12x12xf32>
    %21 = "vector.broadcast"(%0) : (f32) -> vector<21x12x12xf32>
    %22 = "vector.broadcast"(%0) : (f32) -> vector<21x12x12xf32>
    %23 = "vector.broadcast"(%0) : (f32) -> vector<21x12x12xf32>
    %24 = "vector.broadcast"(%0) : (f32) -> vector<21x12x12xf32>
