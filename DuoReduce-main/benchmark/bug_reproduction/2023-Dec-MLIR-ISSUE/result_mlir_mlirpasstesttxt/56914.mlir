...
passed compiler: [['func.func(convert-linalg-to-loops)','func.func(convert-scf-to-cf)','expand-strided-metadata','finalize-memref-to-llvm','lower-affine','convert-func-to-llvm','convert-arith-to-llvm','reconcile-unrealized-casts']]
...
valid and unique compilation path: [['func.func(convert-linalg-to-loops)','func.func(convert-scf-to-cf)','expand-strided-metadata','finalize-memref-to-llvm','lower-affine','convert-func-to-llvm','convert-arith-to-llvm','reconcile-unrealized-casts']]
...
k: 18
TEST Compiler [['func.func(convert-linalg-to-loops)','func.func(convert-scf-to-cf)','expand-strided-metadata','finalize-memref-to-llvm','lower-affine','convert-func-to-llvm','convert-arith-to-llvm','reconcile-unrealized-casts']]
pass test!
TEST Compiler [['func.func(convert-linalg-to-loops)','func.func(convert-scf-to-cf)','expand-strided-metadata','finalize-memref-to-llvm','lower-affine','convert-func-to-llvm','convert-arith-to-llvm','reconcile-unrealized-casts']]
pass test!
...
now at deletion level: 3
k: 17
TEST Compiler [['func.func(convert-scf-to-cf)','func.func(convert-scf-to-cf)','expand-strided-metadata','finalize-memref-to-llvm','convert-func-to-llvm','reconcile-unrealized-casts']]
pass test!
now at deletion level: 2
...
now at deletion level: 2
k: 29
TEST Compiler [['func.func(convert-scf-to-cf)','finalize-memref-to-llvm','convert-func-to-llvm','reconcile-unrealized-casts']]
pass test!
now at deletion level: 1
...
[['func.func(convert-scf-to-cf)','finalize-memref-to-llvm','convert-func-to-llvm','reconcile-unrealized-casts']]
